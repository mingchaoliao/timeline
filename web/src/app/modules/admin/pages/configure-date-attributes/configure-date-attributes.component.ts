...
export class ConfigureDateAttributesComponent implements OnInit {
    ...
    private readonly _createDateAttributeForm: FormGroup;
    ...
    constructor(
        ...
        this._createDateAttributeForm = fb.group({
    ...
    get createDateAttributeForm(): FormGroup {
        return this._createDateAttributeForm;
    }
